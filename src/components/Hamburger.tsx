  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white rounded-xl w-[20px] h-[3px] absolute"
      />
      <motion.div
        initial={{ width: "100%" }}
        animate={onClick ? { opacity: 0 } : onHover ? { width: "70%" } : {}}
        className="bg-white rounded-xl w-[20px] h-[3px] absolute top-[0.5rem]"
      />
      <motion.div
        initial={{ width: "100%" }}
        animate={
        ...
        className="bg-white rounded-xl w-[20px] h-[3px] absolute top-[1rem]"
      />
    </motion.div>
  );
};
